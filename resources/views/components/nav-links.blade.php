...
<li class="group relative max-md:border-b max-md:px-3 max-md:py-3">
    ...
    <ul class="absolute left-0 top-10 z-50 block max-h-0 min-w-[300px] space-y-2 overflow-hidden rounded-b-lg bg-white px-6 shadow-lg transition-all duration-500 group-hover:max-h-[700px] group-hover:pb-4 group-hover:pt-6 group-hover:opacity-100 max-md:top-8">
        <li class="border-b py-3 transition-all hover:border-cyan-600">
            <a href="#" class="block text-slate-800 hover:text-cyan-600"> Certificate in Theology (C. Th.) </a>
        </li>
        <li class="border-b py-3 transition-all hover:border-cyan-600">
            <a href="#" class="block text-slate-800 hover:text-cyan-600"> Diploma in Theology (Dip. Th.) </a>
        </li>
        <li class="border-b py-3 transition-all hover:border-cyan-600">
            <a href="#" class="block text-slate-800 hover:text-cyan-600"> Bachelor of Theology (B. Th.) </a>
        </li>
        <li class="border-b py-3 transition-all hover:border-cyan-600">
            <a href="#" class="block text-slate-800 hover:text-cyan-600"> M.A. Christian Missions </a>
        </li>
    </ul>
</li>
<li class="max-md:border-b max-md:px-3 max-md:py-3">
