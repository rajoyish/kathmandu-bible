      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <ul role="list"
          ...
          <li>
            ...
            <h3 class="mt-6 text-xl font-semibold leading-8 text-slate-600">Rev. Pastor Devilal Shrestha (Dev)</h3>
            <p class="leading-7 text-slate-500">President/Principal</p>
            <p class="text-sm leading-6 text-slate-500">Nigah Sewakai Church</p>
          </li>
          <li>
            <img class="aspect-[14/16] w-full rounded-xl object-cover"
                 src="{{ asset('images/board-members/binod-katwal.png') }}"
                 alt="Rev. Pastor Binod Katwal"/>
          ...
          <li>
            ...
            <h3 class="mt-6 text-xl font-semibold leading-8 text-slate-600">Rev. Pastor Hari Sharan Shrestha</h3>
            <p class="leading-7 text-slate-500">Member</p>
            <p class="text-sm leading-6 text-slate-500">Nigah Community Church</p>
          </li>
          <li>
            <img class="aspect-[14/16] w-full rounded-xl object-cover"
                 src="{{ asset('images/board-members/rajendra-ale.png') }}"
                 alt="Rev. Pastor Rajendra Ale"/>
